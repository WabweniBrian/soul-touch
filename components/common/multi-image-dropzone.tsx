...
const variants = {
  base: "relative rounded-md aspect-square flex justify-center items-center flex-col cursor-pointer h-[100px] w-full border border-dashed border-border transition-colors duration-200 ease-in-out",
  image:
    "border-0 p-0 w-[100px] h-[100px] mb-4 relative shadow-md rounded-md relative",
  active: "border-2",
  disabled:
      ...
      <div>
        <div className="flex-align-center flex-wrap gap-2">
          ...
          {value?.map(({ file, progress }, index) => (
            <div key={index} className={variants.image + "shrink-0"}>
              <img
              ...
              {imageUrls[index] && !disabled && progress === "PENDING" && (
                ...
                >
                  <div className="flex h-5 w-5 cursor-pointer items-center justify-center rounded-md border border-solid border-border bg-white transition-all duration-300 hover:h-6 hover:w-6 dark:border-gray-400 dark:bg-black">
                    <X
