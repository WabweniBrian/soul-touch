...
const variants = {
  base: "relative rounded-md flex justify-center items-center flex-col cursor-pointer min-h-[100px] w-full border border-gray-300 dark:border-gray-700 mt-3 shadow-sm border-dashed transition-colors duration-200 ease-in-out",
  image:
          ...
          {imageUrl && !disabled && (
            ...
            >
              <div className="border-border0 flex h-5 w-5 items-center justify-center rounded-md border bg-white transition-all duration-300 hover:h-6 hover:w-6 dark:bg-black">
                <X className="text-rose-500" width={16} height={16} />
              </div>
            </div>
          )}
        </div>
  ...
  return (
    <button
      className={twMerge(
        ...
        // color
        "border border-border text-gray-400 shadow hover:bg-gray-100 hover:text-gray-500 dark:text-gray-100 dark:hover:bg-gray-700",
        // size
